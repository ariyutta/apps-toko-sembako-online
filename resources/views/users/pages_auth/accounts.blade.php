                    ...
                    <div class="col-sm-8 mt-2 mb-2">
                        <div class="table-responsive">
                            ...
                            <div class="d-flex justify-content-end">
                                <a style="font-weight: bold" href="{{ url('home/edit_accounts/'.$data->id) }}" class="btn btn-purple mt-2 mr-2"> Ubah Data</a>
                                <a style="font-weight: bold" href="{{ url('home') }}" class="btn btn-secondary mt-2"> Kembali</a>
                            </div>
                        </div>
                    </div>
                </div>
