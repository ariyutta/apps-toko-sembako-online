...
@section('title')
    <div class="page-title-right">
        <ol class="breadcrumb m-0">
            ...
            <li class="breadcrumb-item"><a href="{{ url('home/accounts') }}">My Account</a></li>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card-box shadow">
                ...
                <form action="{{ url('home/simpan_accounts', $data->id) }}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="row">
                        ...
                        <div class="col-sm-8 mt-2 mb-2">
                            <div class="table-responsive">
                                ...
                                <div class="d-flex justify-content-end mb-2">
                                    ...
                                    <a style="font-weight: bold" href="{{ url('home/accounts') }}" class="btn btn-secondary mt-3"> Kembali</a>
                                </div>
                            </div>
                        </div>
                    </div>
