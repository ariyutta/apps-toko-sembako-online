...
@section('title')
    <div class="page-title-right">
        <ol class="breadcrumb m-0">
            ...
            <li class="breadcrumb-item"><a href="{{ url('dashboard/bahan_pokok') }}">Bahan Pokok & Bumbu Dapur</a></li>
                    ...
                    <div class="col-sm-6">
                        ...
                        <form action="{{ url('dashboard/tambah_keranjang/'.$data->id) }}" method="POST">
                            ...
                            <div class="d-flex justify-content-center">
                                ...
                                <a href="{{ url('dashboard/bahan_pokok') }}" class="btn btn-secondary"> <span style="font-weight: bold">Kembali</span> </a>  
                            </div>
                        </form>
                    </div>
                </div>
