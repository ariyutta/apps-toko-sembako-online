...
@section('title')
    <div class="page-title-right">
        <ol class="breadcrumb m-0">
            ...
            <li class="breadcrumb-item"><a href="{{ url('home/makanan_ringan') }}">Makanan Ringan</a></li>
                            ...
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                <form action="{{ url('home/tambah_keranjang/'.$data->id) }}" method="POST">
                                    ...
                                    <div class="d-flex justify-content-center">
                                        ...
                                        <a href="{{ url('home/makanan_ringan') }}" class="btn btn-secondary"> <span style="font-weight: bold">Kembali</span> </a>  
                                    </div>
                                </form>
                            </div>
